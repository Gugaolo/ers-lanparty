...
export default function SignupPage() {
  ...
  const handleSignUp = async (e: FormEvent) => {
    ...
    if (!isValidEmail(email)) {
      setMessage("Napaka: Neveljaven e-poštni naslov");
      setLoading(false);
      return;
    }
    ...
    if (error) {
      ...
      setMessage("Račun s tem e-mailom že obstaja. Prijavi se ali uporabi drug e-mail.");
    } else {
      setMessage("Profil ustvarjen. Preveri e-mail (če je zahtevana potrditev) in nato se prijavi.");
    }
    ...
    >
      <section className="mx-auto max-w-xl px-6 pb-16 pt-14">
        ...
        <p className="mt-2 text-white/80">
          Vnesi e-mail in geslo za nov račun. Po ustvaritvi se prijavi na strani za prijavo.
        </p>
        ...
        <div className="mt-8 space-y-6">
          ...
          >
            {oauthLoading ? "Preusmerjam..." : "Prijava z Google računom"}
          </button>
